...
import { Product, Invoice, Category, Boutique, UserRole } from '../types';
import { TrendingUp, AlertTriangle, Wallet, Package, ArrowUpRight, Filter, Calendar, Store, CreditCard, CheckCircle2, XCircle, ChevronRight, Clock, Lock, Unlock, Loader2 } from 'lucide-react';
...
export const Dashboard: React.FC<DashboardProps> = ({ 
  ...
  }, [boutiques, invoices, timeRange]);  return (
    <div className="space-y-8 animate-in fade-in duration-500 overflow-y-auto h-full pb-20 scrollbar-hide font-sans">
      ...
      <div className="flex flex-col lg:flex-row justify-between lg:items-center gap-6 pb-2">
        <div>
           <div className="text-[10px] font-black uppercase tracking-[0.2em] text-farm-600 dark:text-farm-400 mb-1.5 flex items-center gap-2">
              ...
              Live Management Admin
           </div>
           <h2 className="text-3xl font-display font-black text-slate-800 tracking-tight leading-none uppercase">
             {t('dashboard.title')}
           </h2>
           <p className="text-xs text-slate-400 font-bold tracking-wide mt-1 uppercase">{t('dashboard.subtitle')}</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
        ...
        {isVisible('kpi-sales') && (
          ...
          >
            {/* Elegant SVG Sparkline Curve in background */}
        ...
        {isVisible('kpi-orders') && (
          <div className="lg:col-span-4 bg-white dark:bg-slate-900 rounded-[2.5rem] p-8 border border-white/80 dark:border-slate-800/80 shadow-[0_8px_30px_rgba(0,0,0,0.02)] flex flex-col justify-between relative overflow-hidden min-h-[220px]">
             ...
             <div className="flex items-center justify-between gap-6 my-2">
                <div className="text-left">
                   <div className="mb-3">
                      ...
                      <p className={`text-2xl font-black ${lowStockCount > 0 ? 'text-amber-500' : 'text-slate-805'}`}>
                         {lowStockCount}
                      </p>
                   </div>
                   <div>
                ...
                {/* SVG Circular Donut resembling template circular chart with central orange sphere */}
                <div className="relative w-28 h-28 shrink-0 flex items-center justify-center">
                   ...
                   {/* Central clay looking solid dot inside donut as in template */}
      ...
      {isVisible('boutique-status-tracker') && (
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
         ...
         {isVisible('table-recent') && (
            <div className="lg:col-span-8 bg-white dark:bg-slate-900 rounded-[2.5rem] p-8 border border-white/80 dark:border-slate-800/80 shadow-[0_8px_30px_rgba(0,0,0,0.02)]">
               ...
               {/* Activity list strictly resembling Feed List in template */}
               <div className="space-y-4">
